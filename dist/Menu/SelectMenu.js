...
var SelectMenu = function SelectMenu(_ref) {
  ...
  var createMenuItems = function createMenuItems() {
    ...
    React.Children.map(children, function (child) {
      var newProps = {
        ...
        id: "".concat(children.indexOf(child).toString(), "_pgn__menu-item"),
        role: 'link'
      };
  ...
  return /*#__PURE__*/React.createElement(className, _objectSpread(_objectSpread({}, props), {}, {
    ...
    onClick: open
  }, selected !== defaultIndex() ? children[selected].props.children : defaultMessage), /*#__PURE__*/React.createElement("div", {
